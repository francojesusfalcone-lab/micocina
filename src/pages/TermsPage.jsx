...
export default function TermsPage() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
      <div className="bg-white border-b border-surface-200 px-4 py-4 flex items-center gap-3 pt-safe">
        <button onClick={() => navigate(-1)} className="w-9 h-9 rounded-xl bg-surface-100 flex items-center justify-center">
          <ChevronLeft size={20} />
        </button>
        <h1 className="text-lg font-display font-bold text-gray-900">Términos y Condiciones</h1>
      </div>
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-24 space-y-5 text-sm text-gray-700 leading-relaxed">

        <p className="text-xs text-gray-400">Última actualización: marzo 2026</p>

        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">1. Aceptación</h2>
          <p>Al usar MiCuchina aceptás estos términos. Si no los aceptás, no uses la app.</p>
        </section>

        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">2. El servicio</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">3. Tus datos</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">4. Plan Premium</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">5. Uso correcto</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-bold text-gray-900">6. Limitación de responsabilidad</h2>
